      ...
      <div class="container-modal" id="container">
        ...
        <form method="POST" action="signup.php" enctype="multipart/form-data">
            ...
            <div class="account-type d-flex">
              <button type="button" class="type-btn sign-btn me-4" id="type1">Doctor</button>
            ...
            <div id="doc-info" style="display: none;">
              ...
              <input type="file" name="verification_id" required />
            </div>
            <button type="submit" class="sign-btn mobile-signup-btn">Sign Up</button>
          </form>
        </div>
