        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Bringing Hope to Children</h5>
                <p class="card-text">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Healing in Action</h5>
                <p class="card-text">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Bridging Generations with Care</h5>
                <p class="card-text">
          ...
          <div class="col-lg-3 col-md-6 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title">Empowering the Young Minds</h5>
                <p class="card-text">
